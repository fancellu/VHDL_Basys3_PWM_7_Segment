...
# Switches
set_property PACKAGE_PIN V17 [get_ports {PWM[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[0]}]
set_property PACKAGE_PIN V16 [get_ports {PWM[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[1]}]
set_property PACKAGE_PIN W16 [get_ports {PWM[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[2]}]
set_property PACKAGE_PIN W17 [get_ports {PWM[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[3]}]
set_property PACKAGE_PIN W15 [get_ports {PWM[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[4]}]
set_property PACKAGE_PIN V15 [get_ports {PWM[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM[5]}]
set_property PACKAGE_PIN W14 [get_ports {PWM[6]}]
